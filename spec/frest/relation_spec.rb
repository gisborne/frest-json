    ...
    it 'can insert data into the relation' do
      n.insert_relation(
           ...
           fields: [
               ...
               :cars],
           values: [
                ['59f196ae-061f-40fc-a5b7-855896f3deb2', '1@a.com', 1.5, '52b2a550-e72c-4b66-8fb0-1e30da89b4de', '2005-01-01', '17:23', 0],
                ['b3ae4f23-9f77-484d-82d6-f8ae6c101fc0', '2@a.com', 1.4, 'a0ad5b0d-8ccd-4be6-8594-4a13db1946d2', '2003-06-01', '16:40', 2]
           ]
      )
    end
